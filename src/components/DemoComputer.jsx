...
const DemoComputer = (props) => {
    ...
    // la texture qui doit afficher dans le moniteur de l'ordinateur
    const txt = useVideoTexture(props.texture ? props.texture : '/textures/project/project1.mp4')

    // inverser verticalement la texture dans le moniteur
    useEffect(() => {
        if (txt)
            txt.flipY = false
    }, [txt]);

    // l'animation du computer lorsque le l'on change de projet
    useGSAP(() => {
